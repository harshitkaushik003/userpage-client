...
const Card = ({item, index}) => {
  return (
    <div className='card w-full h-40 flex justify-between items-center'>
        <div className='w-20 h-full flex justify-center items-center mr-4'>
        ...
        <div className='w-3/4 h-full text-sm flex justify-between items-center'>
